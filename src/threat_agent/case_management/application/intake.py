...
from ...contracts import Entity, Evidence, EvidenceStatus, Scope
from ...judgment.domain.models import Claim, EvidenceGap, EvidenceRole, Hypothesis, InvestigationState
...
def initialize_state(raw: dict[str, Any]) -> InvestigationState:
    ...
    if requested_scenarios:
        from ...judgment.domain.scenarios import activate_scenario

...
from .models import EvidenceBundle, FactFindingBundle, InvestigationState
from .orchestration import score_tool
...
class ToolRegistry:
    ...
    def _query(self, domain: str, evidence_types: frozenset[str], state: InvestigationState, parameters: dict[str, Any]) -> EvidenceBundle:
        return self.repository.query(domain, evidence_types, state, parameters)
